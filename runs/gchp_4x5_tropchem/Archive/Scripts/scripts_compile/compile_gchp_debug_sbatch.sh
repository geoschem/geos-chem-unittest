...
# Make WITHOUT RRTMG
make -j${SLURM_NTASKS} NC_DIAG=yes CHEM=XXCHEMXX EXTERNAL_GRID=yes DEBUG=yes BOUNDS=yes FPE=yes DEVEL=yes TRACEBACK=yes MET=geos-fp GRID=4x5 NO_REDUCED=yes UCX=no hpc 2>&1 | tee ~/GCHP/outErr.log
