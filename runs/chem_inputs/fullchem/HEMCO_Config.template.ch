...
###
### NOTES:
### --> The biomass burning POA scale factor is the same as for the biofuel and
###    anthro sources. 
###
...
###
### --> BOND_BIOMASS must be set to false if GFED3 or FINN is enabled.
###
### --> BASE_SHIPNO must be set to false if PARANOx is enabled.
###############################################################################
...
#0 ICOADS_SHIP_SO2     $ROOT/ICOADS_SHIP/v2014-07/ICOADS.gen.1x1.nc                    SO2             2002/1-12/1/0          C xy kg/m2/s  SO2  11/15/60     10 5
...
#------------------------------------------------------------------------------
# If PARANOX is not used: SHIPNO_BASE is set automatically to true if (and only
# if) PARANOX is turned off
#------------------------------------------------------------------------------
(((SHIPNO_BASE
0 ICOADS_SHIP_NO       $ROOT/ICOADS_SHIP/v2014-07/ICOADS.gen.1x1.nc                    NO              2002/1-12/1/0          C xy kg/m2/s  NO    1/5         10 1
...
0 AEIC_SO2  $ROOT/AEIC/v2014-10/aeic_2005.geos.1x1.47L.nc  FUELBURN 2005/1-12/1/0 C xyz kg/m2/s SO2  111     20 1 
