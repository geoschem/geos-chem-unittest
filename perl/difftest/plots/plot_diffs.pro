...
pro Plot_Diffs, InFile, _EXTRA=e
   
   ; Search for default input file
   if ( N_Elements( InFile ) eq 0 ) then begin

      ; Assume default file has *.input extension
      InFile = MFindFile( '*.input' )
